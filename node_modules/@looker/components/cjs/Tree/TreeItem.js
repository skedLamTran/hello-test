...
const _excluded = ["className", "color", "density", "disabled", "href", "itemRole", "labelBackgroundOnly", "onBlur", "onClick", "onFocus", "onKeyDown", "onKeyUp", "onMouseEnter", "onMouseLeave", "rel", "selected", "target"],
...
const TreeItem = (0, _styledComponents.default)(_ref => {
  ...
  const hasLabelBackgroundOnly = contextLabelBackgroundOnly || propsLabelBackgroundOnly;
  ...
  const density = (0, _utils2.undefinedCoalesce)([propsDensity, contextDensity]);
  const color = (0, _utils2.undefinedCoalesce)([propsColor, contextColor]);
  const statefulProps = {
    color,
    disabled,
    hovered,
  ...
  return _react.default.createElement(_utils2.HoverDisclosureContext.Provider, {
  ...
  }, wrapperProps), _react.default.createElement(_TreeItemContent.TreeItemContent, _extends({
    ...
    tabIndex: -1,
    target: target
  }, ariaProps, focusVisibleHandlers, statefulProps), hasLabelBackgroundOnly ? _react.default.createElement(_TreeItemLabel.TreeItemLabel, statefulProps, inside) : inside), outside));
}).withConfig({

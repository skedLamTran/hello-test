...
const ToggleSwitch = (0, _styledComponents.default)((0, _react.forwardRef)((_ref, ref) => {
  ...
  const rippleHandlers = (0, _Ripple.useRippleHandlers)(callbacks, _objectSpread({}, (0, _pick.default)(props, _Ripple.rippleHandlerKeys)), disabled);
  return _react.default.createElement("div", _extends({
    ...
    ref: ref
  }, (0, _InputProps.pickInputProps)(props))), _react.default.createElement(_Track.Track, {
    on: on,
...
})(["", " ", " align-items:center;display:flex;height:", ";justify-content:center;opacity:", ";position:relative;width:", ";input{cursor:", ";height:100%;left:0;margin:0;opacity:0;position:absolute;top:0;width:100%;z-index:1;}"], _designTokens.reset, _designTokens.space, ({
  theme
}) => theme.space.u6, ({
  disabled
}) => disabled && _constants.DISABLED_OPACITY, ({
  theme
}) => theme.space.u10, ({
  disabled,
  readOnly

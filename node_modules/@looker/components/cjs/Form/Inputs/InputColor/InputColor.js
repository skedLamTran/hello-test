...
const InputColorInternal = (0, _react.forwardRef)((_ref, ref) => {
  let hideInput = _ref.hideInput,
      id = _ref.id,
      name = _ref.name,
  ...
  const setColorState = newColor => {
    setColor(newColor);
    const newTextValue = newColor ? (0, _utils2.simpleHsvToHex)(newColor) : '';
  ...
  const handleInputTextChange = e => {
    ...
    const isValid = (0, _utils2.isValidColor)(newValue) || newValue === '';
...
const InputColor = (0, _styledComponents.default)(InputColorInternal).withConfig({

...
const After = ({
  ...
  const iconAfterOrSuffix = (iconAfter || typeof after === 'string') && _react.default.createElement(_InputTextContent.InputTextContent, {
    pl: "u2",
    pr: "u2"
  ...
  const validationIcon = !noErrorIcon && validationType === 'error' && _react.default.createElement(_InputTextContent.InputTextContent, {

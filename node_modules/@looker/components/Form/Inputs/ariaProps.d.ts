...
export declare function omitAriaAndValidationProps(props: AriaAndValidationProps): import("lodash").Omit<AriaAndValidationProps, "required" | "aria-describedby" | "aria-invalid" | "aria-label" | "aria-labelledby" | "validationType">;
export {};

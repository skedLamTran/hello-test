...
var hasAsideCSS = css(["flex-direction:row;& > ", "{width:0;}"], Section);
var LayoutLayout = forwardRef(function (_ref, forwardedRef) {
...
export var Layout = styled(LayoutLayout).withConfig({
  displayName: "Layout",
  componentId: "sc-vtli68-0"
})(["", " display:flex;flex:1 1 auto;overflow:", ";", ""], commonLayoutCSS, function (_ref2) {

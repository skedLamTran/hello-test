...
export declare const get_alert: (sdk: IAPIMethods, alert_id: number, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IAlert, IError>>;
export declare const update_alert: (sdk: IAPIMethods, alert_id: number, body: Partial<IWriteAlert>, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IAlert, IError | IValidationError>>;
export declare const update_alert_field: (sdk: IAPIMethods, alert_id: number, body: Partial<IAlertPatch>, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IAlert, IError | IValidationError>>;
export declare const delete_alert: (sdk: IAPIMethods, alert_id: number, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<void, IError>>;
...
export declare const enqueue_alert: (sdk: IAPIMethods, alert_id: number, force?: boolean | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<void, IError>>;
...
export declare const delete_embed_secret: (sdk: IAPIMethods, embed_secret_id: number, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<string, IError>>;
...
export declare const activate_app_user: (sdk: IAPIMethods, client_guid: string, user_id: number, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<string, IError | IValidationError>>;
export declare const deactivate_app_user: (sdk: IAPIMethods, client_guid: string, user_id: number, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<string, IError>>;
...
export declare const board: (sdk: IAPIMethods, board_id: number, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IBoard, IError>>;
export declare const update_board: (sdk: IAPIMethods, board_id: number, body: Partial<IWriteBoard>, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IBoard, IError | IValidationError>>;
export declare const delete_board: (sdk: IAPIMethods, board_id: number, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<string, IError>>;
...
export declare const board_item: (sdk: IAPIMethods, board_item_id: number, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IBoardItem, IError>>;
export declare const update_board_item: (sdk: IAPIMethods, board_item_id: number, body: Partial<IWriteBoardItem>, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IBoardItem, IError | IValidationError>>;
export declare const delete_board_item: (sdk: IAPIMethods, board_item_id: number, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<string, IError>>;
...
export declare const board_section: (sdk: IAPIMethods, board_section_id: number, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IBoardSection, IError>>;
export declare const update_board_section: (sdk: IAPIMethods, board_section_id: number, body: Partial<IWriteBoardSection>, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IBoardSection, IError | IValidationError>>;
export declare const delete_board_section: (sdk: IAPIMethods, board_section_id: number, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<string, IError>>;
...
export declare const get_all_commands: (sdk: IAPIMethods, request: IRequestGetAllCommands, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<ICommand[], IError>>;
export declare const create_command: (sdk: IAPIMethods, body: Partial<IWriteCommand>, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<ICommand, IError | IValidationError>>;
export declare const update_command: (sdk: IAPIMethods, command_id: number, body: Partial<IUpdateCommand>, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<ICommand, IError | IValidationError>>;
export declare const delete_command: (sdk: IAPIMethods, command_id: number, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<void, IError>>;
...
export declare const create_dashboard_element: (sdk: IAPIMethods, body: Partial<IWriteDashboardElement>, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IDashboardElement, IError | IValidationError>>;
...
export declare const datagroup: (sdk: IAPIMethods, datagroup_id: number, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IDatagroup, IError>>;
export declare const update_datagroup: (sdk: IAPIMethods, datagroup_id: number, body: Partial<IWriteDatagroup>, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IDatagroup, IError | IValidationError>>;
...
export declare const search_groups_with_roles: (sdk: IAPIMethods, request: IRequestSearchGroups, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IGroupSearch[], IError>>;
export declare const search_groups_with_hierarchy: (sdk: IAPIMethods, request: IRequestSearchGroups, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IGroupHierarchy[], IError>>;
...
export declare const search_permission_sets: (sdk: IAPIMethods, request: IRequestSearchModelSets, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IPermissionSet[], IError>>;
...
export declare const search_roles_with_user_count: (sdk: IAPIMethods, request: IRequestSearchRoles, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IRoleSearch[], IError>>;
...
export declare const set_role_groups: (sdk: IAPIMethods, role_id: number, body: Partial<number[]>, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IGroup[], IError | IValidationError>>;
...
export declare const set_role_users: (sdk: IAPIMethods, role_id: number, body: Partial<number[]>, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IUser[], IError | IValidationError>>;
...
export declare const theme: (sdk: IAPIMethods, theme_id: number, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<ITheme, IError>>;
export declare const update_theme: (sdk: IAPIMethods, theme_id: number, body: Partial<IWriteTheme>, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<ITheme, IError | IValidationError>>;
...
export declare const create_user_credentials_api3: (sdk: IAPIMethods, user_id: number, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<ICreateCredentialsApi3, IError | IValidationError>>;
...
export declare const set_user_roles: (sdk: IAPIMethods, user_id: number, body: Partial<number[]>, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IRole[], IError>>;
...
export declare const send_user_credentials_email_password_reset: (sdk: IAPIMethods, user_id: number, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<ICredentialsEmail, IError>>;
export declare const wipeout_user_emails: (sdk: IAPIMethods, user_id: number, body: Partial<IUserEmailOnly>, fields?: string | undefined, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IUser, IError | IValidationError>>;
...
export declare const all_user_attributes: (sdk: IAPIMethods, request: IRequestAllBoardSections, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IUserAttribute[], IError>>;

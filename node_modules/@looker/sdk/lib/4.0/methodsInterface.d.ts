...
export interface ILooker40SDK extends IAPIMethods {
    ...
    activate_app_user(client_guid: string, user_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<string, IError | IValidationError>>;
    deactivate_app_user(client_guid: string, user_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<string, IError>>;
    ...
    board(board_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<IBoard, IError>>;
    update_board(board_id: number, body: Partial<IWriteBoard>, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<IBoard, IError | IValidationError>>;
    delete_board(board_id: number, options?: Partial<ITransportSettings>): Promise<SDKResponse<string, IError>>;
    ...
    board_item(board_item_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<IBoardItem, IError>>;
    update_board_item(board_item_id: number, body: Partial<IWriteBoardItem>, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<IBoardItem, IError | IValidationError>>;
    delete_board_item(board_item_id: number, options?: Partial<ITransportSettings>): Promise<SDKResponse<string, IError>>;
    ...
    board_section(board_section_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<IBoardSection, IError>>;
    update_board_section(board_section_id: number, body: Partial<IWriteBoardSection>, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<IBoardSection, IError | IValidationError>>;
    delete_board_section(board_section_id: number, options?: Partial<ITransportSettings>): Promise<SDKResponse<string, IError>>;
    ...
    get_all_commands(request: IRequestGetAllCommands, options?: Partial<ITransportSettings>): Promise<SDKResponse<ICommand[], IError>>;
    create_command(body: Partial<IWriteCommand>, options?: Partial<ITransportSettings>): Promise<SDKResponse<ICommand, IError | IValidationError>>;
    update_command(command_id: number, body: Partial<IUpdateCommand>, options?: Partial<ITransportSettings>): Promise<SDKResponse<ICommand, IError | IValidationError>>;
    delete_command(command_id: number, options?: Partial<ITransportSettings>): Promise<SDKResponse<void, IError>>;
    ...
    create_dashboard_element(body: Partial<IWriteDashboardElement>, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<IDashboardElement, IError | IValidationError>>;
    ...
    search_groups_with_roles(request: IRequestSearchGroups, options?: Partial<ITransportSettings>): Promise<SDKResponse<IGroupSearch[], IError>>;
    search_groups_with_hierarchy(request: IRequestSearchGroups, options?: Partial<ITransportSettings>): Promise<SDKResponse<IGroupHierarchy[], IError>>;
    ...
    search_roles_with_user_count(request: IRequestSearchRoles, options?: Partial<ITransportSettings>): Promise<SDKResponse<IRoleSearch[], IError>>;
    ...
    set_role_groups(role_id: number, body: Partial<number[]>, options?: Partial<ITransportSettings>): Promise<SDKResponse<IGroup[], IError | IValidationError>>;
    role_users(request: IRequestRoleUsers, options?: Partial<ITransportSettings>): Promise<SDKResponse<IUser[], IError>>;
    set_role_users(role_id: number, body: Partial<number[]>, options?: Partial<ITransportSettings>): Promise<SDKResponse<IUser[], IError | IValidationError>>;
    ...
    theme(theme_id: number, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<ITheme, IError>>;
    update_theme(theme_id: number, body: Partial<IWriteTheme>, options?: Partial<ITransportSettings>): Promise<SDKResponse<ITheme, IError | IValidationError>>;
    ...
    set_user_roles(user_id: number, body: Partial<number[]>, fields?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<IRole[], IError>>;

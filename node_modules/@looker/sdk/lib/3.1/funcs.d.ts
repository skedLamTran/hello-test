...
export declare const all_user_attributes: (sdk: IAPIMethods, request: IRequestAllHomepageSections, options?: Partial<ITransportSettings> | undefined) => Promise<SDKResponse<IUserAttribute[], IError>>;
